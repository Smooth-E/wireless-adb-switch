...
/**
 * The Base preference with two target areas divided by a vertical divider.<br><br>
 * Original implementation was taken from
 * <a href="https://cs.android.com/android/platform/superproject/main/+/main:frameworks/base/packages/SettingsLib/TwoTargetPreference/src/com/android/settingslib/widget/TwoTargetPreference.java;drc=4d01a45c44da726927a736c81d71c72de04e23d7">
 * Android Open Source Project's Settings app
 * </a> and then slightly modified.
 */
public class TwoTargetPreference extends Preference {
    ...
    public void onBindViewHolder(@NonNull PreferenceViewHolder holder) {
        ...
        final View divider = holder.findViewById(R.id.target_divider);
